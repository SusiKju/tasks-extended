...
/** Markiert die übergebenen Nachrichten als gelesen (Tab-Badge/Fett-Markierung verschwinden). */
export async function markFuerUnsRead(familyId: string, itemIds: string[]): Promise<void> {
